...
def main(args):
    if args.mode == 'train':
        ...
        if args.save_path is None:
            args.save_path = os.path.join('/data/xiaocy/save', time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', type=str, default='cuda:3', choices=['cuda:0', 'cpu'], help='device')
